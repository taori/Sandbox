...
namespace ODataAuthorization.Models
{
    public partial class AdventureWorksContext : DbContext
    {
		...
		private static readonly LoggerFactory ConsoleLoggerFactory = CreateLoggerFactory();
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder
	                .UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=AdventureWorks;Trusted_Connection=True;")
